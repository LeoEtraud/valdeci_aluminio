  ...
  return (
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <button onClick={() => scrollToSection('projetos')} className="text-gray-700 hover:text-primary transition-colors">
                Projetos
              </button>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
              <span className="text-glass-blue">Portões Automatizados</span><br />
              <span className="text-2xl md:text-4xl lg:text-5xl font-medium">& Soluções em Alumínio</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
              Especialistas em automação residencial e comercial. Portões, portas de alumínio e instalações de vidro com tecnologia de ponta e garantia total.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Button 
                variant="outline"
                className="border-2 border-white text-white hover:bg-white hover:text-slate-800 px-8 py-4 rounded-full text-lg font-semibold transition-all"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Soluções completas em metalurgia com foco em automação, qualidade e design moderno para residências e empresas.
            </p>
          </div>
            ...
            <Card className="group bg-gradient-to-br from-slate-50 to-gray-100 hover:shadow-xl transition-all transform hover:-translate-y-1">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800 mb-3">Portões Automatizados</h3>
                </div>
                <img 
            ...
            <Card className="group bg-gradient-to-br from-slate-50 to-gray-100 hover:shadow-xl transition-all transform hover:-translate-y-1">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800 mb-3">Portas de Alumínio</h3>
                </div>
                <img 
            ...
            <Card className="group bg-gradient-to-br from-slate-50 to-gray-100 hover:shadow-xl transition-all transform hover:-translate-y-1">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-slate-800 mb-3">Soluções em Vidro</h3>
                </div>
                <img 
          ...
          <div className="bg-gradient-to-r from-primary to-glass-blue rounded-2xl p-8 md:p-12 text-white text-center">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-3xl md:text-4xl font-bold mb-4">Tecnologia e Qualidade Garantida</h3>
              <p className="text-xl mb-8 opacity-90">
                Utilizamos equipamentos de última geração e materiais certificados para entregar projetos que superam expectativas.
              </p>
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center">
                  <div className="text-4xl font-bold mb-2">500+</div>
                  <div className="opacity-90">Projetos Realizados</div>
                </div>
                <div className="text-center">
      ...
      <section id="projetos" className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Confira alguns dos nossos trabalhos mais recentes e veja a qualidade que entregamos em cada projeto.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Sistema completo com controle remoto e sensor de segurança"
              },
              {
                ...
                description: "Portas de alumínio com vidro temperado para estabelecimento comercial"
              },
              {
                ...
                description: "Vidro temperado com perfis de alumínio para maior segurança"
              },
              {
                image: "https://images.unsplash.com/photo-1504328345606-18bbc8c9d7d1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&h=600",
                title: "Estrutura Personalizada",
                description: "Projeto sob medida com acabamento de alta qualidade"
              },
              {
                ...
                description: "Sistema automatizado para uso comercial intensivo"
              },
              {
                ...
                description: "Instalação residencial com vidro temperado e ferragens especiais"
              }
            ].map((project, index) => (
      ...
      <section id="sobre" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-slate-800 mb-6">
                <span className="text-aluminum">Sobre a</span> SerralArt
              </h2>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Com mais de 15 anos de experiência no mercado, a SerralArt se consolidou como referência em soluções automatizadas e trabalhos em alumínio e vidro na região.
              </p>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-slate-800 mb-2">Qualidade Certificada</h4>
                    <p className="text-gray-600">Todos os nossos produtos passam por rigoroso controle de qualidade e contam com certificação ISO.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-slate-800 mb-2">Equipe Especializada</h4>
                    <p className="text-gray-600">Profissionais capacitados e em constante atualização com as mais modernas técnicas do mercado.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-lg font-semibold text-slate-800 mb-2">Tecnologia Avançada</h4>
                    <p className="text-gray-600">Equipamentos de última geração para garantir precisão e acabamento perfeito em todos os projetos.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button variant="outline" className="border-2 border-aluminum text-aluminum hover:bg-aluminum hover:text-white px-6 py-3 rounded-full font-semibold">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 rounded-xl p-6 text-center">
                  <div className="text-3xl font-bold text-glass-blue mb-2">100%</div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A satisfação dos nossos clientes é nossa maior conquista. Veja alguns depoimentos de quem confia na SerralArt.
            </p>
          </div>
            ...
            {[
              {
                name: "Maria Rosa",
                initials: "MR",
                review: "Excelente trabalho! O portão automatizado ficou perfeito e o atendimento foi impecável do início ao fim. Super recomendo!",
              ...
              },
              {
                name: "João Silva",
                initials: "JS",
                review: "Profissionais muito competentes. A instalação das portas de alumínio ficou linda e dentro do prazo combinado.",
              ...
              },
              {
                name: "Ana Costa",
                initials: "AC",
                review: "O envidraçamento da sacada superou minhas expectativas. Qualidade top e preço justo. Muito satisfeita!",
      ...
      <section id="contato" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Pronto para começar seu projeto? Entre em contato conosco e solicite seu orçamento gratuito.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <Card className="bg-slate-50 rounded-2xl p-8">
              <CardContent className="p-0">
                <h3 className="text-2xl font-bold text-slate-800 mb-6">Solicite seu Orçamento</h3>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <Select value={formData.serviceType} onValueChange={(value) => setFormData({ ...formData, serviceType: value })}>
                      ...
                      <SelectContent>
                        <SelectItem value="portao-automatizado">Portão Automatizado</SelectItem>
                        <SelectItem value="portas-aluminio">Portas de Alumínio</SelectItem>
                        <SelectItem value="solucoes-vidro">Soluções em Vidro</SelectItem>
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-1">Telefones</h4>
                      <p className="text-gray-600">
                        (11) 9999-8888<br />
                        (11) 3333-4444
                      </p>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">contato@serralart.com.br</p>
                    </div>
                  </div>
              ...
              <Card className="bg-slate-50 rounded-2xl p-6">
                <CardContent className="p-0">
                  <h4 className="text-xl font-bold text-slate-800 mb-4">Horário de Funcionamento</h4>
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    <h5 className="font-semibold text-slate-800 mb-3">Atendimento 24h para Emergências</h5>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                Especialistas em automação residencial e comercial. Qualidade e tecnologia em cada projeto há mais de 15 anos.
              </p>
              <div className="flex space-x-4">
                <Button size="icon" className="bg-primary rounded-full hover:bg-blue-600">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li><button className="hover:text-glass-blue transition-colors">Portões Automatizados</button></li>
                <li><button className="hover:text-glass-blue transition-colors">Portas de Alumínio</button></li>
                <li><button className="hover:text-glass-blue transition-colors">Soluções em Vidro</button></li>
                <li><button className="hover:text-glass-blue transition-colors">Manutenção</button></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-300">
                ...
                <div className="flex items-center">
                  ...
                  <span>contato@serralart.com.br</span>
                </div>
                <div className="flex items-start">
          ...
          <div className="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 SerralArt. Todos os direitos reservados.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0 text-sm text-gray-400">
              <button className="hover:text-glass-blue transition-colors">Política de Privacidade</button>
              <button className="hover:text-glass-blue transition-colors">Termos de Uso</button>
            </div>
          </div>
        </div>
      </footer>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button size="icon" className="bg-green-500 hover:bg-green-600 text-white w-14 h-14 rounded-full shadow-lg transition-all transform hover:scale-110">
